Feature: Q&A Services Functionality Checking
...
#    Then Success! message should be displayed
  ...
  @Suite
  Scenario: 2.2 Verify that the Q&A Services page is being Load and displayed accurately
    Given Student can successfully login student portal
    Then Q&A Menu should be displayed correctly no top navigation
    When Click on Q&A Menu from top navigation
  ...
  @Suite
  Scenario: 2.3 Verify that the Question and Answer page is being Load and displayed accurately
    Given Student can successfully login student portal
    Then Q&A Menu should be displayed correctly no top navigation
    When Click on Q&A Menu from top navigation
    And Click proceed on any subject from Q&A services Page
  ...
  @Suite
  Scenario: 2.4 Verify that the Question and Answer page Search question is working properly
    Given Student can successfully login student portal
    Then Q&A Menu should be displayed correctly no top navigation
    When Click on Q&A Menu from top navigation
    And Click proceed on any subject from Q&A services Page
